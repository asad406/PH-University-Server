...
userSchema.statics.isJWTIssuedBeforePasswordChanged = function (passwordChangeTimestamp: Date, jwtIssueTimestamp: number) {
    const passwordChangeTimes = new Date(passwordChangeTimestamp).getTime() / 1000
